...
? "SII: Pregled obracuna amortizacije po kontima "
?? "     Datum:",gDatObr
...
? m
? " Rbr.  Inv.broj   RJ    Datum    S.inventar                   jmj  kol  "+" "+PADC("NabVr",LEN(gPicI))+" "+PADC("OtpVr",LEN(gPicI))+" "+PADC("Amort.",LEN(gPicI))+" "+PADC("O+Am",LEN(gPicI))+" "+PADC("SadVr",LEN(gPicI))
? m
return
*}
