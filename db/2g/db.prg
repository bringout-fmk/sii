...
#ifndef CPP
#include "class(y).ch"
CREATE CLASS TDbSii INHERIT TDB
...
/*! \fn *void TDbSii::setgaDbfs()
 *  \brief Setuje matricu gaDbfs 
 */
*void TDbSii::setgaDbfs()
*{
method setgaDBFs()
...
/*! \fn *void TDbSii::install(string cKorisn,string cSifra,variant p3,variant p4,variant p5,variant p6,variant p7)
 *  \brief osnovni meni za instalacijske procedure
 */

*void TDbSii::install(string cKorisn,string cSifra,variant p3,variant p4,variant p5,variant p6,variant p7)
*{
...
/*! \fn *void TDbSii::kreiraj(int nArea)
 *  \brief kreiranje baze podataka OS-a
 */
 
*void TDbSii::kreiraj(int nArea)
*{
...
/*! \fn *void TDbSii::obaza(int i)
 *  \brief otvara odgovarajucu tabelu
 *  
 *      
 */

*void TDbSii::obaza(int i)
*{
...
if i==F_KONTO .or. i==F_RJ .or. i==F_K1
	lIdiDalje:=.t.
endif
...
/*! \fn *void TDbSii::skloniSezonu(string cSezona, bool finverse,bool fda,bool fnulirati,bool fRS)
...
*void TDbSii::skloniSezonu(string cSezona, bool finverse,bool fda,bool fnulirati,bool fRS)
*{
...
Beep(4)
if Pitanje(,"Brisanje otpisanog s.invent.i promjena u toku protekle god.! Nastaviti ?","N")="N"
  closeret
endif
